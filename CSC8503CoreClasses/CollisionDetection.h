...
namespace NCL {
	...
	public:
		...
		static bool CheckAxis(const Vector3& axis, float halfSizeA,
			const Vector3* axesB, const Vector3& halfSizeB,
			const Vector3& delta, float& penetration, Vector3& bestAxis);
		...
		static bool OBBAABBIntersection(const OBBVolume& obb, const Transform& obbTransform,
